...
ENV DEPENDENCY_PACKAGES="libpq-dev libcurl4-openssl-dev libpng-dev libjpeg-dev libfreetype6-dev libpng-dev libmcrypt-dev libxml2-dev libmagickwand-6.q16-dev libc-client-dev libkrb5-dev libssh2-1-dev"
