...
ENV BUILD_PACKAGES="sudo cron wkhtmltopdf supervisor ssl-cert locales"
...
RUN docker-php-ext-configure pgsql -with-pgsql=/usr/include/postgresql \
    ...
    && docker-php-ext-install -j$(nproc) pdo pdo_pgsql pgsql pdo_mysql mysql mysqli curl gd mbstring json bcmath mcrypt zip fileinfo soap calendar imap
